...
export interface ApiEpisodeEpisode extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vimeoHLS: Schema.Attribute.String & Schema.Attribute.Required;
  };
}

export interface ApiHomepageCategoryHomepageCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'homepage_categories';
  info: {
    displayName: 'Homepage Category';
    pluralName: 'homepage-categories';
    singularName: 'homepage-category';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::homepage-category.homepage-category'
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    rowType: Schema.Attribute.Enumeration<['Movies', 'Shows']>;
...
export interface ApiShowShow extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    showUrl: Schema.Attribute.String & Schema.Attribute.Required;
    thumbnail: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiVideoVideo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    description: Schema.Attribute.Text;
    duration: Schema.Attribute.Integer;
    homepage_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::homepage-category.homepage-category'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::homepage-category.homepage-category': ApiHomepageCategoryHomepageCategory;
